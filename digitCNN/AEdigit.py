...
parser.add_argument("m", help="Number of Datapoints, usually 10k", type=int)
...
print 'Initial W JCost: ', RegJCost(WAll, patches) 
...
res = minimize(fun=RegJCost, x0= WAll, method='L-BFGS-B', tol=10**g.tolexp, jac=BackProp, args=(patches, ) ) # options = {'disp':True}
bestWAll = res.x

print 'Final W JCost', RegJCost(bestWAll, patches)
...
totend = time.time()
print ' '
print'AEdigit.py took ', totend - totStart, 'seconds to run'
