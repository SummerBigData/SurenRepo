...
#Conv Layer 2
c2 = Conv2D(64, kernel_size=(3, 3),activation='relu', padding='same')(c1)
#p1 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2))(c1)
#d1 = Dropout(0.2)(p1)
#Conv Layer 3
c3 = Conv2D(128, kernel_size=(3, 3), activation='relu', padding='same')(c2)
...
dc4 = Conv2DTranspose(3, kernel_size=(2, 2), activation='sigmoid', padding='same')(dc2)
outputs = dc4
